...
from tno.connectinfra_adapter import create_app
from tno.connectinfra_adapter.settings import EnvSettings
...
logger = get_logger("tno.connectinfra_adapter.main")

app = create_app("tno.connectinfra_adapter.settings.%sConfig" % EnvSettings.env().capitalize())
